...
tasks.jar {
	manifest {
		attributes(mapOf(
				...
				"Automatic-Module-Name" to "com.elex_project.strix"
		))
	}
}
	...
	publications {
		create<MavenPublication>("mavenJava") {
			...
			pom {
				...
				scm {
					connection.set("scm:git:https://github.com/elex-project/strix.git")
					developerConnection.set("scm:git:https://github.com/elex-project/strix.git")
					url.set("https://github.com/elex-project/strix")
				}
			}
		}
	}
